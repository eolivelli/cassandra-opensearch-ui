...
/**
 * Base class for integration tests: launches a real Cassandra 5 and a real OpenSearch 3.x via
 * Testcontainers, started once and shared by every integration test in the JVM (Testcontainers'
 * Ryuk sidecar stops them when the JVM exits). Mirrors the DB UI module's test harness.
 */
